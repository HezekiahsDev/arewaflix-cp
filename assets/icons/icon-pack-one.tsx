...
export const HeartIcon = createIcon(({ stroke, accent, strokeWidth }) => (
  <>
    <Path
      d="M20.84 4.61c-1.54-1.32-3.94-1.07-5.45.56L12 8.18l-3.39-3.01c-1.51-1.63-3.91-1.88-5.45-.56C1.2 6.08 1.5 9.76 4.09 12.17L12 19.5l7.91-7.33c2.59-2.41 2.89-6.09.93-8.56z"
      fill={accent}
    />
  </>
));

export const CommentIcon = createIcon(({ stroke, accent, strokeWidth }) => (
  <>
    <Path
...
export const ShareIcon = createIcon(({ stroke, accent, strokeWidth }) => (
  <>
    <Path
...
export const VolumeIcon = createIcon(({ stroke, accent, strokeWidth }) => (
  <>
    <Path
...
export const VolumeOffIcon = createIcon(({ stroke, accent, strokeWidth }) => (
  <>
    <Path
      d="M11 5L6 9H2v6h4l5 4V5z"
      stroke={stroke}
